...
<html>
	...
	<body>
			...
			<div class="top_c">
				...
				<%int num=0; %>
					<ul class="top-menu-nav">
						...
						<%
							List<String> roleTypeList1 = (List)session.getAttribute("role_typeList");
								for(String ro:roleTypeList1){
							if(ro.equals("warehouse")||ro.equals("goods")||ro.equals("code")||ro.equals("customer")||ro.equals("account")||ro.equals("user")||ro.equals("organization")||ro.equals("dept")){
						%>
						<li>
						...
						<%
							List<String> roleTypeList2 = (List)session.getAttribute("role_typeList");
								for(String ro:roleTypeList2){
							if(ro.equals("purchase")||ro.equals("purchaseGods")||ro.equals("purchaseOrderGoods")||ro.equals("purchaseOrder")){
						%>
						<li>
							<a href="javascript:void(0)" onclick="changeMenu(2)">学生信息管理<i
								class="tip-up"></i> </a>
						...
						<%
							List<String> roleTypeList3 = (List)session.getAttribute("role_typeList");
								for(String ro:roleTypeList3){
							if(ro.equals("sale")||ro.equals("saleGoods")||ro.equals("saleOrder")||ro.equals("saleOrderGoods")||ro.equals("saleReturnGoods")||ro.equals("saleReturn")){
						%>
						<li>
							<a href="javascript:void(0)" onclick="changeMenu(3)">课程信息管理<i
								class="tip-up"></i> </a>
						...
						<%
							List<String> roleTypeList4 = (List)session.getAttribute("role_typeList");
								for(String ro:roleTypeList4){
							if(ro.equals("cashStatement")){
						%>
						<li>
							<a href="javascript:void(0)" onclick="changeMenu(4)">学生成绩管理<i
								class="tip-up"></i> </a>
						...
						%>
						<li>
							<a href="javascript:void(0)" onclick="changeMenu(5)">班级信息管理<i
								class="tip-up"></i> </a>
						</li>
						<%
							List<String> roleTypeList6 = (List)session.getAttribute("role_typeList");
								for(String ro:roleTypeList1){
									if(ro.equals("resource")||ro.equals("job")){
						%>
							<li>
								<a href="javascript:void(0)" onclick="changeMenu(6)">用户信息管理<i
								class="tip-up"></i> </a>
							</li>
						<%				
										break;	
				...
				<div class="top-nav">
					上午好，欢迎您，${erpAccount.username}！&nbsp;&nbsp;
					<a target="Conframe" href="public/toUpdatePw.do">修改密码</a> |
					<a href="">安全退出</a>
				</div>
			</div>
				...
				<div class="acc">
					...
					<c:forEach items="${myDoPathList}" var="m">
						...
						<ul class="kid">
							...
							<li>
								<b class="tip"></b><a target="Conframe"
									href="account/toAccountAdd.do">添加员工信息</a>
							</li></c:if>
		...
		<div class="Conframe">
			<iframe name="Conframe" id="Conframe" src="student/toList.do"></iframe>
		</div>
		<!--右边框架结束-->
